...
public class CompatDecoderFactory<T> implements DecoderFactory<T> {
     ...
     * @param clazz a class that implements {@link net.arvin.selector.uis.views.subscaleview.decoder.ImageDecoder} or {@link net.arvin.selector.uis.views.subscaleview.decoder.ImageRegionDecoder}.
     */
